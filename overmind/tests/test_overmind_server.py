...
class TestOvermindTools:
    ...
    async def test_overmind_start_with_options(self):
        ...
        with patch('mcp_server_overmind.server.OvermindManager') as mock_manager_class:
            ...
            mock_manager_instance.run_command = AsyncMock(return_value=mock_result)
            ...
            mock_manager_instance.run_command.assert_called_once()
            called_command = mock_manager_instance.run_command.call_args[0][0]
